...
\newcommand{\FirmaName}{\mbox{Richard Wolf GmbH}}
\newcommand{\FirmaAnschrift}{Pforzheimer Straße 32}
\newcommand{\FirmaPLZ}{75438}
\newcommand{\FirmaStadt}{Knittlingen}
\newcommand{\FirmaLogo}[1][1.5]{\includegraphics[keepaspectratio=true, height=#1cm]{DefaultContent/200803_DefaultWolf_Logo}}
...
\newcommand{\AusarbeitungThema}{RaHM-Lab\\Positionsregelung Drohne}
\newcommand{\AusarbeitungBezeichnung}{Projekt Software Engineering 2}
\newcommand{\AusarbeitungZeitraum}{6 Monate}
\newcommand{\AusarbeitungAbgabeDatum}{30.04.2022} % Check again!
