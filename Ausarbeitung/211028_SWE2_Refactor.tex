...
In dem dieser \Arbeit\ zugrundeliegenden Code wurden Klassen gefunden, bei welchen die Bezeichnung nicht selbstsprechend erscheint. Um dieser Problematik entgegenzuwirken, soll eine dieser betreffenden Klassen umbenannt werden. Hierbei handelt es sich um die Klasse \CodeClass{PosBridge} nach  \CodeClass{MainClass}.\\
\Commit{3c5aeed610150bd19f75241af48a2777cb4c582a}\\
